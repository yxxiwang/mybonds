...
var UI = function() {
		...
		var tagDynamic = function($ipt, opts) {
				yepnope({
					test: $.fn.TagDynamic,
					load: ['/public/js/libs/tagDynamic/jquery.tagDynamic.js', '/public/js/libs/tagDynamic/jquery.tagDynamic.css', '/site_media/static/geeknews/jquery.autocomplete.js', '/site_media/static/geeknews/jquery.autocomplete.css'],
					complete: function() {
						$ipt.TagDynamic(opts);
					}
				});
		...
		var global_search = function() {
				...
				yepnope({
					...
					load: ['/site_media/static/geeknews/jquery.autocomplete.js', '/site_media/static/geeknews/jquery.autocomplete.css'],
					complete: function() {
						var $ipt = $('#search');
		...
		var foot_hide = function(item, position) {
				if (position == "bottom") {
					item.css({
						"background": "url(/site_media/static/geeknews/lodging.gif) center bottom no-repeat",
						"padding-bottom": "30px"
					});
				} else {
					item.css({
...
var Avatar = function() {
		var upload = function($btn) {
				yepnope({
					'test': window.qq,
					'load': ['/public/js/libs/ajaxupload/fileuploader.js', '/public/js/libs/ajaxupload/fileuploader.css'],
					'complete': function() {
...
Cast.wall = function() {
	...
	var isloading = false,
		...
		start = -1;
	var data_server = '/geeknews/get_cast_list/';
	var load_times = 11;
	var current_num;
...
readSeed.wall = function() {
	...
	var isloading = false,
		...
		start = -1,
		t = '';
	var data_server = '/geeknews/load_seeds/';
	var load_times = 11;
	var current_num;
	var get_view_mode = function() {
			var tmp = $view_mode.find('li.on');
	...
	var do_load = function(callback) {
			...
			if (t == '') {
				if (em_mode1 == 'list') {
					if (current_num == 10 || start== -1 ) num = 10;//first loads news num
					else num = 10;//every time loads news num
				} else {
					start = 35;
					if (is_special_click === '') t = $('.cast-wall').attr('id');
					else t = '';
	...
	var render_list = function(data) {
			...
			if (otype=="ppl" || otype =="rdd"){
					template = "<div class='item type-{{type}}-list cast-item' >\n \
            <div class='entry {{tag_class}} cast-card'>\n \
                <div class='header' style='width: 650px;' >\n \
                    <h1 id='header_links'><a target='_blank' style='font-size: 20px;' href='/geeknews/research?u={{username}}&amp;likeid={{hashid}}'>{{title}}</a></h1>\n \
                </div>\n \
                ...
                <div class='time' style='display: none;'>\n \
					...
					template = "<div id='test123' class='item type-{{type}}-list cast-item'  >\n \
            <div class='entry {{tag_class}} cast-card'>\n \
                <div class='meta' style='margin-top: 5px; height:2px; width: 600px;'>\n \
                ...
                <div class='main' style='font-size: 14px; width: 620px;'>\n \
                    \“{{text}}\”\n \
                </div>\n \
                </br>\n \
                <div class='bottom_line ' style='margin-left: 0px;height:2px; width: 620px; display: none;' ><span></span>\n \
                </div>\n \
            </div>\n \
        </div>";
      }//style='margin-top: 5px;    height: 5px;'  ① style='display: none;'  style='width: 620px;  border-right:1px  double gray;'
      ...
      /*var relatedoc = "<table><tr><td class='font-gray-b-10pt'><a href='/research?u=wxi&amp;likeid=1472272683306320126' target='_blank'>中央财政支持新能源及可再生能源跨越式发展</a></td></tr>\n \
			...
			$('#test123 ').click(function() {
				var bottomline="<div class='bottom_line ' style='margin-left: 0px;height:2px; width: 620px;' ><span></span></div>"
    			alert('You are going to visit: ' ); 
					$list_box.isotope('remove', $(bottomline));
    	});
			setTimeout(auto_load, 2000)
		};
	return {
